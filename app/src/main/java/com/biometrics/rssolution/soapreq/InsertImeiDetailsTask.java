...
public class InsertImeiDetailsTask extends
		AbstractProgressableAsyncTask<SoapObject, Integer> {

	public  String Imei,Vtp,Descr;
	
	private static final String TAG = "InsertIMEIDetails";
	...
	public InsertImeiDetailsTask(String imeino,String vtpno,String Desc) {
...
//		if (cityForecastNode != null) {
			...
			int isSuccess = Integer.parseInt(response
					.getPrimitivePropertySafelyAsString("InsertIMEIDetailsResult"));
