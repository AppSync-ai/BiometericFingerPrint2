...
import com.example.Mydatabse.Student;
...
public class MainActivitya extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mdb.addStudent(new Student("Sidhant", "leftImpression", "rightImpression", "100"));
		
		
		Finger1 = (ImageView)findViewById(R.id.fingerprint);
		capture = (Button)findViewById(R.id.capture);
		Finger1.setBackgroundColor(Color.GRAY);
		...
		init.setOnClickListener(new View.OnClickListener() {
			...
			Student stu =	mdb.getUserByLimpression("leftimpression");
			Log.i("database","student name : "+stu.getStudentName());
